...
import ExpenShort from "./ExpenShort";
import ExpenSol from "./ExpenSol";

const Income = () => {
  const [isExSalOpen, setIsExSelOpen] = useState(false)
  const [isExpenseShort, setIsExpenseShort] = useState(false)
  
  const handelExpenseShort = ()=> {
    setIsExpenseShort(!isExpenseShort)
  }
  const handelIsExSalOpen = ()=> {
    setIsExSelOpen(!isExSalOpen)
  }
  return (
