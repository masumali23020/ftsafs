...
const MoveCard = ({movie}) => {
    const {cover,title,genre,price,id} = movie || {}
 
  return (
    <figure className="p-4 border border-black/10 shadow-sm dark:border-white/10 rounded-xl" key={id}>
    <img className="w-full object-cover" src={getImageUrl(cover)} alt="" />
